...
public class DefaultData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if(ddlAuto.equals("create")) {
            VoteOptions sixSchool = new VoteOptions("Bekobod tumani 6-maktab", 0);
            VoteOptions fourSchool = new VoteOptions("Bekobod tumani 4-maktab", 0);
            VoteOptions OneSchool = new VoteOptions("Bekobod tumani 1-maktab", 0);
            VoteOptions FiftyFourSchool = new VoteOptions("Bekobod tumani 44-maktab", 0);
            VoteOptions FiftySchool = new VoteOptions("Bekobod tumani 40-maktab", 0);
